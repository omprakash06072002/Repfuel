...
window.REPFUEL_SUPABASE_URL =
  'https://wukvqhuwtikczsgdfvws.supabase.co';

window.REPFUEL_SUPABASE_PUBLISHABLE_KEY =
  'sb_publishable_z42tPwWWCnZjwKr3AfxIZg_yTjm-Axq';

if (
  window.supabase &&
  window.REPFUEL_SUPABASE_URL.startsWith('https://') &&
  !window.REPFUEL_SUPABASE_URL.includes('YOUR_PROJECT_ID') &&
  !window.REPFUEL_SUPABASE_PUBLISHABLE_KEY.includes('YOUR_PUBLISHABLE_KEY')
) {
